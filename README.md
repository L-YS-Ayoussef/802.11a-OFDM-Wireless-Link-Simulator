...
- **RX**
| Constellation (RX, Baseline, ZF) | Constellation (RX, Baseline, MMSE) | Constellation (RX, Clip+Filter, ZF) | (RX, Clip+Filter, MMSE) | BER Vs. SNR |
|---|---|---|---|---|
| ![fig6](tests/BPSK_tc1/fig6.png) | ![fig7](tests/BPSK_tc1/fig7.png) | ![fig8](tests/BPSK_tc1/fig8.png) | ![fig9](tests/BPSK_tc1/fig9.png) | ![fig10](tests/BPSK_tc1/fig10.png) |
---
